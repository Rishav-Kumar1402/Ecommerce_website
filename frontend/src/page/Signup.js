    ...
    <div className="p-3 m:p-4">
      <div className="w-full max-w-md bg-white m-auto flex items-center flex-col p-4">
        <div className="w-20 h-20 overflow-hidden rounded-full drop-shadow-md shadow-md">
          ...
          <label htmlFor="profileImage">
            <div className="absolute bottom-0 h-1/3 bg-slate-500 bg-opacity-50 w-full text-center">
              <p className="text-sm text-white cursor-pointer">Upload</p>
            </div>
        ...
        <form className="w-full py-3 flex flex-col" onSubmit={handleSubmit}>
          ...
          <button className=" mt-2 max-w-[150px] text-white text-xl font-medium text-center py-1 rounded-full w-full m-auto bg-red-500 hover:bg-red-600 cursor-pointer">
            Signup
          </button>
        </form>
        <p>
