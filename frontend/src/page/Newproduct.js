  ...
  return (
    <div className='p-4'>
      <form className='m-auto w-full max-w-md shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <div className='h-40 w-full bg-slate-200 my-3 rounded flex items-center cursor-pointer justify-center'>
          {
        ...
        <textarea rows={2} className='bg-slate-200 p-1 my-1 resize-none' name="description" onChange={handleOnChange} value={data.description}/>

        <button className='bg-red-500 hover:bg-red-600 text-white text-lg font-medium my-2 drop-shadow '>Submit</button>
      </form>
    </div>
